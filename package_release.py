...
archive=root/'Kindle安装包-v9.6.10-ui-layout-fix.zip'
...
original=root.parent/'v9.6.9-calendar-heatmap'
...
for name in ['daily-final','daily-final-page-3','books-filters','total-year','total-week']:
...
for i,name in enumerate(['daily-final','daily-final-page-3','total-year','books-filters']):

...
archive=root/'Kindle安装包-v9.6.6-stats-filters.zip'
...
original=root.parent/'v9.6.5-ui-polish'
...
for name in ['daily-final','daily-final-page-3','books-filters','total-month','total-week']:
...
for i,name in enumerate(['daily-final','daily-final-page-3','total-month','books-filters']):

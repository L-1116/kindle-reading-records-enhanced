...
archive=root/'Kindle安装包-v9.6.5-ui-polish.zip'
...
original=root.parent/'v9.6.4-ui-calendar'
...
for name in ['daily-final','daily-final-page-3','books-polished','total-final','empty-six-row']:
...
for i,name in enumerate(['daily-final','daily-final-page-3','total-final','books-polished']):

...
适用于越狱 Kindle 的原生阅读时长统计插件增强版。当前版本为
`v9.7.2-测试版`，可在设备上查看月历、阅读热力、周/年统计、书籍筛选、当天阅读详情、
月份详情和最近 8 周趋势。
...
- 月历标题与年度月份柱可进入同一个月份详情，查看核心指标、Top 3 和每日趋势。
- 本周总时长可进入最近 8 周趋势，当前周用边框强调。
...
1. 从 [Releases](../../releases) 下载 `v9.7.2-测试版` 安装包并解压。

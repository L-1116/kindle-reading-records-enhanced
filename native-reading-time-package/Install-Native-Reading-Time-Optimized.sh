...
STAGE="$BASE/.install-9.6.5-ui-polish.$$"
...
cleanup_stage() { case "$STAGE" in /mnt/us/reading-time/.install-9.6.5-ui-polish.[0-9]*) rm -rf "$STAGE";; esac; rm -f "$DATA.bak.new.$$"; }

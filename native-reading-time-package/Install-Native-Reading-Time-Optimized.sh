...
cleanup_stage() { case "$STAGE" in /mnt/us/reading-time/.install-9.7.3-测试版.[0-9]*) rm -rf "$STAGE";; esac; rm -f "$DATA.bak.new.$$"; }
...
echo "$(date): 9.7.3-测试版 installed and running, daemon_cmp=identical"
toast "Reading records 9.7.3-测试版 installed"; exit 0

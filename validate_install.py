...
BASELINE=ROOT.parent/'v9.6.7-week-view/native-reading-time-package'
...
old_release=state/'releases/9.6.7-week-view'; old_release.mkdir(parents=True)
...
release=state/'releases/9.6.8-summary-sync-fix'
...
assert (state/'VERSION').read_text().strip()=='9.6.8-summary-sync-fix'

...
BASELINE=ROOT.parent/'v9.6.6-stats-filters/native-reading-time-package'
...
old_release=state/'releases/9.6.6-stats-filters'; old_release.mkdir(parents=True)
...
release=state/'releases/9.6.7-week-view'
...
assert (state/'VERSION').read_text().strip()=='9.6.7-week-view'

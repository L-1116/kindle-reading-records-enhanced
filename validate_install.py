...
BASELINE=ROOT.parent/'v9.6.8-summary-sync-fix/native-reading-time-package'
...
old_release=state/'releases/9.6.8-summary-sync-fix'; old_release.mkdir(parents=True)
...
release=state/'releases/9.6.9-calendar-heatmap'
...
assert (state/'VERSION').read_text().strip()=='9.6.9-calendar-heatmap'

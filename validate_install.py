...
BASELINE=ROOT.parent/'v9.6.3-optimized-pw6-5.19.6-cmp-fix/native-reading-time-package'
...
old_release=state/'releases/9.6.3-optimized'; old_release.mkdir(parents=True)
...
release=state/'releases/9.6.4-ui-calendar'
...
assert (state/'VERSION').read_text().strip()=='9.6.4-ui-calendar'
